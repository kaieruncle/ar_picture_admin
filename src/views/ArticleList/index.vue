<template>
  <div class="content_list_container">
    ...
    <div class="table_btn_box">
      <a-button type="primary" @click="wakeUpHandleInfoModal">新建文章</a-button>
...
import { getarticlelist, deletearticle, putarticlesuggest } from './api';
...
const getList = async () => {
  ...
  const { list: newList, count } = await getarticlelist(payload)
  list.value = newList || []
